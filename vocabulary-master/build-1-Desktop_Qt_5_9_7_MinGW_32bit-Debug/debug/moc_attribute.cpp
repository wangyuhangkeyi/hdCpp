...
QT_MOC_LITERAL(3, 19, 21) // "on_pushButton_clicked"
    ...
    "Attribute\0refresh\0\0on_pushButton_clicked"
};
...
void Attribute::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Attribute *_t = static_cast<Attribute *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Attribute::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Attribute::refresh)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Attribute::staticMetaObject = {
    { &MyDialog::staticMetaObject, qt_meta_stringdata_Attribute.data,
      qt_meta_data_Attribute,  qt_static_metacall, nullptr, nullptr}
};
